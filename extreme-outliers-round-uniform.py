...
extreme_outliers_df.to_csv("extreme-outliers-round-uniform.csv", index=False)

print(f"{len(extreme_outliers_df)} extreme outliers round uniform saved to 'extreme-outliers-round-uniform.csv'.")
