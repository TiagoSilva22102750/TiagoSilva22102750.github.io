...
normal_outliers_df.to_csv("normal-outliers-round-uniform.csv", index=False)

print(f"{len(normal_outliers_df)} normal outliers saved to 'normal-outliers-round-uniform.csv'.")