...
function updateInstructions(index) {
  ...
  if (index === 0) {
    instructionsDiv.innerHTML = `
      <h2>Instructions:</h2>
      <p>Adjust the slope or position of the red line to have a value of <b>-0.50</b>.</p>
    `;
  } else if (index === 1) {
    instructionsDiv.innerHTML = `
      <h2>Instructions:</h2>
      <p>Adjust the slope or position of the red line to have a value of <b>0.75</b>.</p>
    `;
  }
}
