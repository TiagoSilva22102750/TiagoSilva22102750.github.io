...
normal_outliers_df.to_csv("normal-outliers-narrow-equidistant.csv", index=False)

print(f"{len(normal_outliers_df)} normal outliers saved to 'normal-outliers-narrow-equidistant.csv'.")