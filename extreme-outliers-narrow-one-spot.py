...
extreme_outliers_df.to_csv("extreme-outliers-narrow-one-spot.csv", index=False)

print(f"{len(extreme_outliers_df)} extreme outliers narrow one spot saved to 'extreme-outliers-narrow-one-spot.csv'.")
