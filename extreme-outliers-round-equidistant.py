...
extreme_outliers_df.to_csv("extreme-outliers-round-equidistant.csv", index=False)

print(f"{len(extreme_outliers_df)} extreme outliers round equidistant saved to 'extreme-outliers-round-equidistant.csv'.")
