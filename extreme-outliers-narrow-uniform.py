...
extreme_outliers_df.to_csv("extreme-outliers-narrow-uniform.csv", index=False)

print(f"{len(extreme_outliers_df)} extreme outliers narrow uniform saved to 'extreme-outliers-narrow-uniform.csv'.")
